                    ...
                    for pos in list_of_positions:
                        if pos.x == is_start and pos.y == is_end and pos.orientation == orientation:
                            ...
                            if '?' in call:
                                ...
                                matching_pos.isolate_dict[isolate] = 'C'
                            elif 'I' in call:
                                matching_pos.isolate_dict[isolate] = 'I'
                            elif 'O' in call:
                                matching_pos.isolate_dict[isolate] = 'O'
                            else:
                                matching_pos.isolate_dict[isolate] = '+'
                    ...
                    if match == False:
                        ...
                        if list_of_positions == []:
                            if '?' in call:
                                ...
                                isolate_dict[isolate] = 'C'
                            elif 'I' in call:
                                isolate_dict[isolate] = 'I'
                            elif 'O' in call:
                                isolate_dict[isolate] = 'O'
                            else:
                                isolate_dict[isolate] = '+'
